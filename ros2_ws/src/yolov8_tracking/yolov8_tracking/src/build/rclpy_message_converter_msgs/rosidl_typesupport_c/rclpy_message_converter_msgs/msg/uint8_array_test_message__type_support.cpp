...
static const _Uint8ArrayTestMessage_type_support_symbol_names_t _Uint8ArrayTestMessage_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rclpy_message_converter_msgs, msg, Uint8ArrayTestMessage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rclpy_message_converter_msgs, msg, Uint8ArrayTestMessage)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rclpy_message_converter_msgs, msg, Uint8ArrayTestMessage)() {
  return &::rclpy_message_converter_msgs::msg::rosidl_typesupport_c::Uint8ArrayTestMessage_message_type_support_handle;
}
