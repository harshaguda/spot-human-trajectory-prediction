...
void fetch_function__TestArray__data(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const double *>(
    get_const_function__TestArray__data(untyped_member, index));
  auto & value = *reinterpret_cast<double *>(untyped_value);
  value = item;
}

void assign_function__TestArray__data(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<double *>(
    get_function__TestArray__data(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TestArray_message_member_array[1] = {
  {
    ...
    fetch_function__TestArray__data,  // fetch(index, &value) function pointer
    assign_function__TestArray__data,  // assign(index, value) function pointer
