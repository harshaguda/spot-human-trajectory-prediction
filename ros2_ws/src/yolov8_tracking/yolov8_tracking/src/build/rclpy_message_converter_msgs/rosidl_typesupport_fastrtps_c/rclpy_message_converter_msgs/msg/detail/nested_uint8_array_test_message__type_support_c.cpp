...
static size_t _NestedUint8ArrayTestMessage__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_rclpy_message_converter_msgs__msg__NestedUint8ArrayTestMessage(
