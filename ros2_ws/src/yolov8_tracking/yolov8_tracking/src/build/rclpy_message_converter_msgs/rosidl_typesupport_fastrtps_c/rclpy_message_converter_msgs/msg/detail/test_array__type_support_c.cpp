...
#include "rclpy_message_converter_msgs/msg/detail/test_array__rosidl_typesupport_fastrtps_c.h"
...
using _TestArray__ros_msg_type = rclpy_message_converter_msgs__msg__TestArray;
...
size_t get_serialized_size_rclpy_message_converter_msgs__msg__TestArray(
  const void * untyped_ros_message,
...
static uint32_t _TestArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rclpy_message_converter_msgs__msg__TestArray(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rclpy_message_converter_msgs
size_t max_serialized_size_rclpy_message_converter_msgs__msg__TestArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _TestArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rclpy_message_converter_msgs__msg__TestArray(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rclpy_message_converter_msgs, msg, TestArray)() {
