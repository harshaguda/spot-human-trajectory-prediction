...
#include "rclpy_message_converter_msgs/msg/detail/uint8_array_test_message__rosidl_typesupport_fastrtps_c.h"
...
using _Uint8ArrayTestMessage__ros_msg_type = rclpy_message_converter_msgs__msg__Uint8ArrayTestMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Uint8ArrayTestMessage__ros_msg_type * ros_message = static_cast<const _Uint8ArrayTestMessage__ros_msg_type *>(untyped_ros_message);
  // Field name: data
  {
  ...
  void * untyped_ros_message)
{
  ...
  _Uint8ArrayTestMessage__ros_msg_type * ros_message = static_cast<_Uint8ArrayTestMessage__ros_msg_type *>(untyped_ros_message);
  // Field name: data
  {
    uint32_t cdrSize;
    cdr >> cdrSize;
...
static uint32_t _Uint8ArrayTestMessage__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rclpy_message_converter_msgs__msg__Uint8ArrayTestMessage(
...
static size_t _Uint8ArrayTestMessage__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_rclpy_message_converter_msgs__msg__Uint8ArrayTestMessage(
...
static message_type_support_callbacks_t __callbacks_Uint8ArrayTestMessage = {
...
static rosidl_message_type_support_t _Uint8ArrayTestMessage__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_Uint8ArrayTestMessage,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rclpy_message_converter_msgs, msg, Uint8ArrayTestMessage)() {
  return &_Uint8ArrayTestMessage__type_support;
}
