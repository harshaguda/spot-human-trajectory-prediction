#Code from : https://github.com/KEDIARAHUL135/PanoramaStitching/blob/master/main.py
import cv2
import numpy as np
...
def FindMatches(BaseImage, SecImage):
    ...
    BaseImage_kp, BaseImage_des = Sift.detectAndCompute(BaseImage, None)
    SecImage_kp, SecImage_des = Sift.detectAndCompute(SecImage, None)
